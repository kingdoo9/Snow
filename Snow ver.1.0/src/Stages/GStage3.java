...
public class GStage3 extends JPanel{
	...
	protected void paintComponent(Graphics g) {
		...
		g.drawImage(new ImageIcon(GConstants.Stage3URL).getImage(), 0, 0, 
				GConstants.FrameWidth, GConstants.FrameHight, null);
		
		Stage3.setLocation(375, 50);
